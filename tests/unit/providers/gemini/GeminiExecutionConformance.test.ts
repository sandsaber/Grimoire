...
defineExecutionBackendConformance('Gemini CLI managed ACP', createDriver);
...
function createDriver(
  ...
  const resolution = deferred<GeminiExecutionInvocation>();
  let stored = 0;
  ...
  return {
    ...
    request: {
      ...
      owner: { kind: 'conversation', ownerId: 'gemini-conformance' },
...
class ConformanceScheduler implements GeminiExecutionScheduler {
