...
defineExecutionBackendConformance('Kimi Code managed ACP', createDriver);
...
function createDriver(
  ...
  const resolution = deferred<KimicodeExecutionInvocation>();
  let stored = 0;
  ...
  return {
    ...
    request: {
      ...
      owner: { kind: 'conversation', ownerId: 'kimicode-conformance' },
...
class ConformanceScheduler implements KimicodeExecutionScheduler {
