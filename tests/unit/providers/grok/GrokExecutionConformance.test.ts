...
defineExecutionBackendConformance('Grok Build managed ACP', createDriver);
...
function createDriver(
  ...
  const resolution = deferred<GrokExecutionInvocation>();
  let stored = 0;
...
class ConformanceScheduler implements GrokExecutionScheduler {
