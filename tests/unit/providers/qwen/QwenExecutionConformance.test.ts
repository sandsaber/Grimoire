...
defineExecutionBackendConformance('Qwen Code managed ACP', createDriver);
...
function createDriver(
  ...
  const resolution = deferred<QwenExecutionInvocation>();
  let stored = 0;
  ...
  return {
    ...
    request: {
      ...
      owner: { kind: 'conversation', ownerId: 'qwen-conformance' },
...
class ConformanceScheduler implements QwenExecutionScheduler {
