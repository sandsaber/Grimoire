/**
 * How a Kimi Code permission request is described to the person answering it.
 *
 * Extracted from the legacy runtime, which now delegates to it, so the flip
 * does not produce a second opinion about what Kimi Code is asking for. Moved
 * rather than written: the words below are the ones a Kimi Code user reads
...
export interface KimicodePermissionPresentation {
...
export function buildKimicodePermissionPresentation(
  rawTitle: string | null | undefined,
  input: Record<string, unknown>,
  locations: Array<{ path: string }> | null | undefined,
): KimicodePermissionPresentation {
