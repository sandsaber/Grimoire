import { KimicodeAcpFileSystem } from './KimicodeAcpFileSystem';

/**
 * What an auxiliary Kimi Code turn may reach on disk, which is less than a chat
 * turn may.
 *
 ...
 */
export function createKimicodeAuxiliaryFileSystem(
  resolveVaultPath: () => string,
): KimicodeAcpFileSystem {
  return new KimicodeAcpFileSystem({
