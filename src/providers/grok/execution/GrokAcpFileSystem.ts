...
export interface GrokAcpFileSystemContext {
...
export class GrokAcpFileSystem {
  constructor(private readonly context: GrokAcpFileSystemContext) {}
  ...
  async writeTextFile(request: AcpWriteTextFileRequest): Promise<AcpWriteTextFileResponse> {
    ...
    if (!approved) throw new Error('Grok Build file write was not approved.');
