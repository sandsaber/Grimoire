import { OpencodeAcpFileSystem } from './OpencodeAcpFileSystem';

/**
 * What an auxiliary OpenCode turn may reach on disk, which is less than a chat
 * turn may.
 *
 ...
 */
export function createOpencodeAuxiliaryFileSystem(
  resolveVaultPath: () => string,
): OpencodeAcpFileSystem {
  return new OpencodeAcpFileSystem({
