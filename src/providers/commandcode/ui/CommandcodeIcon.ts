...
// Vendor monochrome mark: https://commandcode.ai/favicon/2024/safari-pinned-tab.svg
export const COMMANDCODE_ICON: ProviderIconSvg = {
  "kind": "composite",
