...
export interface QwenAcpFileSystemContext {
...
export class QwenAcpFileSystem {
  constructor(private readonly context: QwenAcpFileSystemContext) {}
  ...
  async writeTextFile(request: AcpWriteTextFileRequest): Promise<AcpWriteTextFileResponse> {
    ...
    if (!approved) throw new Error('Qwen Code file write was not approved.');
