...
/**
 * MiMoCode's execution backend: the shared managed-ACP one, under its own id.
 *
 ...
 * sessions.
 */
export class MimocodeExecutionBackend extends ManagedAcpExecutionBackend {
  constructor(context: Omit<ManagedAcpExecutionBackendContext, 'descriptor'>) {
    super({ ...context, descriptor: MIMOCODE_EXECUTION_DESCRIPTOR });
  }
}
 ...
 */
export type MimocodeExecutionBackendContext =
