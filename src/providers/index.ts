...
import { commandcodeWorkspaceRegistration } from './commandcode/app/CommandcodeWorkspaceServices';
...
>> = {
  ...
  commandcode: context => commandcodeWorkspaceRegistration.initialize(context),
