...
interface ReasonixPromptOptions {
  orchestratorMode?: boolean;
}

export function buildReasonixPromptText(
 ...
 */
export function buildReasonixPromptBlocks(
  request: ChatTurnRequest,
  conversationHistory: ChatMessage[] = [],
  options: ReasonixPromptOptions = {},
): AcpContentBlock[] {
  const prompt = buildReasonixPromptText(request, conversationHistory);
