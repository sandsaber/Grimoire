...
- Wechsle provider im composer. Claude Code, Codex, Antigravity CLI, Gemini CLI (Legacy), OpenCode, MiMoCode, Kimi Code, Grok Build, Qwen Code und Devin teilen sich einen model picker.
...
| Rewind | Ja | Nein | Nein | Ja | Nein | Nein | Nein | Nein | Nein | Nein |
| Fork | Ja | Ja | Nein | Ja | Nein | Nein | Nein | Nein | Nein | Nein |
| Provider slash commands | Ja | Nein | Ja | Ja | Ja | Ja | Nein | Ja | Ja | Ja |
| Grimoire-managed MCP UI | Ja | Nein | Ja | Ja | Ja | Ja | Nein | Ja | Ja | Ja |
...
Aktuell wird Grimoire mit Claude Code, Codex, Antigravity CLI, Gemini CLI (Legacy), OpenCode, MiMoCode, Kimi Code, Grok Build, Qwen Code und Devin ausgeliefert.
